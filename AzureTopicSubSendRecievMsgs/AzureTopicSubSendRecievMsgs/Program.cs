...
namespace BasicSendReceiveUsingTopicSubscriptionClient
{
    ...
    class Program
    {
        ...
        const string ServiceBusConnectionString = "Endpoint=sb://freeservicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=abYQHUxh1ERatWnSbb8EReGKxE1/YjgGmDRZ8DLTKZE=";
        const string TopicName = "azurebustopic";
